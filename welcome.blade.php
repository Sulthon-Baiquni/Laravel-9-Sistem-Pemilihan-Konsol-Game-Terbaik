        ...
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="/" class="flex items-center">
                    <img src="{{ asset('nav.png') }}" class="mr-3 h-9 sm:h-9" alt="Flowbite Logo" />
            ...
            <div class="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
                <div>
                    ...
                    <div class="mb-10">
                        ...
                        <p class="text-gray-500 dark:text-gray-400"
                        data-aos="zoom-in-up" data-aos-easing="linear" data-aos-duration="1000" data-aos-delay="600">Masing-masing kriteria yang <a href="/spk"
                    ...
                    <div class="mb-10">
                        ...
                        data-aos="zoom-in-up" data-aos-easing="linear" data-aos-duration="1000" data-aos-delay="800">Tingkat akurasi website pemilihan konsol game
                            ...
                            lengkap data yang
                            digunakan dalam analisis, semakin akurat <a href="/spk"
                                class="font-medium underline text-primary-600 dark:text-primary-500 hover:no-underline"
                ...
                <div>
                    <div class="mb-10">
                        ...
                        <p class="text-gray-500 dark:text-gray-400"
                        data-aos="zoom-in-up" data-aos-easing="linear" data-aos-duration="1000" data-aos-delay="300">Untuk mengakses <a href="/spk"
                                class="font-medium underline text-primary-600 dark:text-primary-500 hover:no-underline"
                    ...
                    <div class="mb-10">
                        ...
                        <p class="text-gray-500 dark:text-gray-400"
                        data-aos="zoom-in-up" data-aos-easing="linear" data-aos-duration="1000" data-aos-delay="500">Pemilihan <a href="/spk"
                                class="font-medium underline text-primary-600 dark:text-primary-500 hover:no-underline"
                                data-aos="zoom-in-up" data-aos-easing="linear" data-aos-duration="1000" data-aos-delay="500">konsol
                                game terbaik</a>
                            omemiliki manfaat seperti : Kemudahan pemilihan membantu mengurangi kebingungan pengguna
            ...
            <div class="grid gap-8 lg:grid-cols-2" data-aos="zoom-in-up" data-aos-duraction="1500" data-aos-delay="450">
                <article
                    ...
                    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a
                            href="/spk">Pemilihan Konsol Game Terbaik</a></h2>
                    <p class="mb-5 font-light text-gray-500 dark:text-gray-400">Website ini disajikan dengan cara yang
                        teratur dan terstruktur,
                        sehingga pengguna dapat dengan mudah melakukan perhitungan pada berbagai konsol game dan membuat
        ...
        <div class="mx-auto max-w-screen-xl">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            <li class="mb-4">
                                <a href="/spk" class="hover:underline">SPK</a>
                            </li>
                            <li>
                                <a href="/spk" class="hover:underline">Konsol Game</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a
                        href="/" class="hover:underline">Sistem Pemilihan Konsol Game</a>.
                </span>
